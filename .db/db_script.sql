...
CREATE DATABASE IF NOT EXISTS `VaesDB2` DEFAULT CHARACTER SET utf8;
USE `VaesDB2`;
...
CREATE TABLE IF NOT EXISTS `Q5` (
        `QUESTION1`INT NOT NULL DEFAULT 0 COMMENT 'physical coordination',
        `QUESTION2`INT NOT NULL DEFAULT 0 COMMENT 'health',
        `QUESTION3`INT NOT NULL DEFAULT 0 COMMENT 'weight',
        `QUESTION4`INT NOT NULL DEFAULT 0 COMMENT 'strength',
        `QUESTION5`INT NOT NULL DEFAULT 0 COMMENT 'sex appeal',
        `QUESTION6`INT NOT NULL DEFAULT 0 COMMENT 'physical attractiveness',
        `QUESTION7`INT NOT NULL DEFAULT 0 COMMENT 'energy level',
        `QUESTION8`INT NOT NULL DEFAULT 0 COMMENT 'sculpted muscles',
        `QUESTION9`INT NOT NULL DEFAULT 0 COMMENT 'physical fitness',
        `QUESTION10`INT NOT NULL DEFAULT 0 COMMENT 'measurements',
        `USER_ID` VARCHAR(100) NOT NULL,  /*--- The id of the user of course		primary and FOREIGN KEY	*/
