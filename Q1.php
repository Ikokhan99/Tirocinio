                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form name="login-form" method="post" action="Q1.php" id="login-form" role="form" style="display: block;">
                            ...
                            <form name="register-form" method="post" action="Q1.php" role="form" style="display: none;" id="register-form">
                                <div class="form-group">
