...
query <- "select u.id as ID,u.sex,u.sexid,u.age,u.time, SUM(a.power) as Power, SUM(a.sexual) as sexual, SUM(a.experience) as Experience, SUM(a.intention) as intention
